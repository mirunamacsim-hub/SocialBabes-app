...
export const ProfileView: React.FC<ProfileViewProps> = ({ profilePic, onUpdateProfilePic, userName }) => {
  ...
  const inputClass = "w-full bg-white/60 border-none rounded-lg p-3 text-sm md:text-base text-on-surface focus:ring-2 focus:ring-primary/40 outline-none placeholder:text-on-surface-variant/50";
  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
        ...
        {/* Create Team */}
        <div className="bg-[#ece5db] p-6 md:p-8 rounded-xl botanical-shadow flex flex-col gap-6 border border-white/20">
          <div className="space-y-2">
            <div className="w-10 h-10 md:w-12 md:h-12 bg-white/60 flex items-center justify-center rounded-lg">
          ...
          <div className="space-y-3 md:space-y-4">
            <div className="space-y-1.5">
              ...
              <input className={inputClass} placeholder="e.g. Social Babes MKT" type="text" />
            </div>
            <div className="space-y-1.5">
        ...
        <div className="bg-[#ece5db] p-6 md:p-8 rounded-xl botanical-shadow flex flex-col gap-6 border border-white/20">
          ...
          <div className="flex-grow flex flex-col justify-end gap-3 md:gap-4">
            <div className="space-y-1.5">
              ...
              <input className={inputClass} placeholder="Enter secure key" type="password" />
            </div>
            <button className="bg-gradient-to-br from-primary to-primary-container text-white text-sm md:text-base font-bold py-3.5 md:py-4 rounded-lg w-full shadow-md hover:opacity-90 transition-none">
              Verify & Join
            </button>
